...
feature_columns = [
    ...
    'attr1_1', 'sinc1_1', 'intel1_1', 'fun1_1', 'amb1_1', 'shar1_1', # Stated preferences
    'attr3_1', 'sinc3_1', 'intel3_1', 'fun3_1', 'amb3_1',             # Self-perception
    'attr_o', 'sinc_o', 'intel_o', 'fun_o', 'amb_o', 'shar_o', 'like'  # Ratings from partner
]
...
plt.title('Confusion Matrix - Logistic Regression (Before SMOTE)', fontsize=16)
